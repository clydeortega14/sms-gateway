...
<body>
        ...
        <center><h2><b>Receipt Of Payment</b></h2></center>
        <p class="p_left"><b>Date:</b> {{ date('F j, Y', strtotime(Carbon\Carbon::now())) }}</p><br>
        <br>
        
        <p class="p_left" style="text-align:justify;">Dear {{ $payment->getCredential->users->name}}, <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You have successfully paid {{ $payment->amount}} to your current subcsription.<br> Please check or kindly log in to <a href="http://smsplus.coredev.ph">smsplus.coredev.ph</a> with your corresponding account to see your Payment receipt. Thank you for using our application, have a nice day!<br>
        </p><br>
        <br>
        <br>
        <br>
